...
int8_t elmo_can_set_target_velocity(int8_t s, int8_t node_id, uint32_t target_vel); // 0x60FF
int8_t elmo_can_set_target_position(int8_t s, int8_t node_id, uint32_t target_pos); // 0x607A
...
int32_t elmo_can_get_enc_px(int8_t s, int8_t node_id); // 6063 00
int32_t elmo_can_get_enc_vx(int8_t s, int8_t node_id); // 606C 00
int8_t elmo_init_motor(int8_t s, int8_t node_id, uint8_t mode = 3);
